...
ui <- page_fluid(
  ...
  tags$head(
    tags$style(HTML("
      ...
      /* De-identification reminder shown under each upload button. */
      .upload-reminder {
        margin: 8px 0 0 2px;
        font-size: 13px;
        font-style: italic;
      ...
      /* Completion / sign-off box at the bottom of the export tab. */
      .export-done-box {
        margin-top: 24px;
        padding: 18px 20px;
        background: #EDF4FF;
    ...
    div(
        ...
        card(
          ...
          field("Upload additional material",
            ...
            tagList(
              ...
              tags$p(class = "upload-reminder",
                     "Please ensure uploaded files are de-identified for blinded peer review.")
            )),
      ...
      nav_panel(
        ...
        card(
          ...
          card_header("Finish preregistration"),
          
          # Completion / sign-off box (first thing after the heading).
          div(
            class = "export-done-box",
            HTML(paste(
              "You&rsquo;ve reached the end of the template &#127881;.",
              "Your preregistration isn&rsquo;t saved until you export it",
              "using the button below. After that, you&rsquo;re ready to register it",
              "(e.g., by uploading your preregistration to OSF or elsewhere)."
            ))
          ),
          ...
          div(
            ...
            tags$span(class = "field-hint",
              paste(
                "To export your preregistration, choose an output format:",
                "Word (.docx) can be edited and includes the text you have",
                "entered only. PDF (.pdf) cannot be edited and includes the",
                "same text plus every PDF you uploaded, merged into a single",
                "file with a divider page before each attachment."
              ))
          ),
